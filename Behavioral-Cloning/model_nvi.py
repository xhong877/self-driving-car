...
model.fit_generator(train_generator, samples_per_epoch= math.ceil(len(train_samples)*6/32)*32, validation_data=validation_generator, nb_val_samples=math.ceil(len(validation_samples)*6/32)*32, nb_epoch=10)
model.save('model_nvi.h5')
